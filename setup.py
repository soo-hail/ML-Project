# Setyp.py Instruction-Manual for our Python-Project, that helps other to install required dependencies, used for creating Python-Packages. Unlike "requirements.txt" it allows to publish out project on "PyPi".
